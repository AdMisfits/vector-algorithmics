...
const benefitItems = [
  ...
  { icon: 'layers', text: '3 Asset Class Diversification' },
  { icon: 'flag', text: 'Section 1256 Tax Efficiency' },
  { icon: 'globe', text: 'Inverse ETF Roth IRA Strategy' },
  { icon: 'users', text: '1,000+ Active Clients' },
  { icon: 'star', text: '4.6/5 Trustpilot Rating' },
  { icon: 'clock', text: 'White-Glove Onboarding' },
  { icon: 'zap', text: 'Custom Risk Profiles' },
];

const faqData = [
  {
    q: 'How does multi-asset diversification work?',
    a: 'You can deploy algorithms across three independent asset classes — mega-cap stocks, futures, and crypto — each with distinct entry logic and risk parameters. Running all three creates genuine diversification with low correlation between strategies. You control which are active at any time.',
  },
  {
    q: 'What\u2019s the inverse ETF strategy for Roth IRAs?',
    a: 'Most retirement accounts prohibit short selling. Our stock algorithm uses inverse ETFs (like SQQQ or SPXU) to capture downside moves within a Roth IRA or 401(k). This gives you market-neutral exposure in accounts that normally only allow long positions — a significant structural advantage.',
  },
  {
    q: 'How does Section 1256 tax treatment work?',
    a: 'Futures contracts under Section 1256 receive automatic 60/40 tax treatment: 60% of gains taxed at long-term capital gains rates, 40% at short-term — regardless of how long the position was held. For high-income earners, this can reduce effective tax rates by 10-15% compared to ordinary income treatment.',
  },
  {
    q: 'What\u2019s the minimum investment?',
    a: 'We require a minimum of $20,000 in liquid capital per asset class. For a full three-strategy deployment, most clients allocate $60K-$150K+ across accounts. The algorithm license ranges from $10,000 to $13,000 depending on strategies selected.',
  },
  {
    q: 'How complex is the setup with multiple brokerages?',
    a: 'Not complex at all — that\u2019s what the white-glove onboarding is for. Our team handles the brokerage account configuration, API connections, and strategy deployment. Typically, futures run through Tradovate or NinjaTrader, stocks through Interactive Brokers, and crypto through your preferred exchange. Setup takes one guided session.',
  },
  {
    q: 'Can I transfer existing positions without triggering tax events?',
    a: 'We don\u2019t move or liquidate your existing positions. The algorithms trade within your existing brokerage accounts using available cash. Your current holdings remain untouched. For retirement accounts, we work within the account\u2019s existing structure — no rollovers or transfers required.',
  },
  {
    q: 'What kind of returns can I expect?',
    a: 'Our algorithms have historically averaged around 50% annually across all strategies. Monthly returns typically range between 5-20%, though performance varies by market conditions. We publish all results transparently, including losses. Past performance does not guarantee future results.',
  },
  {
    q: 'How is my capital protected?',
    a: 'We are a software provider — we never hold, manage, or have access to your capital. Your funds stay in your own accounts at U.S. regulated brokerages with FDIC/SIPC insurance. Every trade has a defined stop-loss with engineered maximum drawdowns. You maintain full control at all times.',
  },
  {
    q: 'Can I adjust risk profiles per strategy?',
    a: 'Yes. Each algorithm has configurable risk parameters. You can run the futures strategy at full allocation while keeping crypto conservative, or pause stocks entirely during earnings season. Adjustments can be made anytime through your dedicated account manager.',
  },
  {
    q: 'Do you work with financial advisors or CPAs?',
    a: 'Yes. We welcome conversations with your advisory team. Several of our clients\u2019 CPAs have reviewed our tax documentation and confirmed the Section 1256 treatment. We can provide trade logs, performance reports, and strategy documentation for their review.',
  },
];
  ...
  return (
    <main>
      ...
      <section className="hero">
        <div className="container">
          <h1>Your Idle Capital Should Be Compounding.</h1>
          <p>
            Multi-asset algorithmic trading across stocks, futures, and crypto &mdash; with tax-optimized
            execution, inverse ETF strategies for retirement accounts, and white-glove onboarding.
          </p>
          <div className="hero-proof">
            134.6% annual NASDAQ return &middot; Section 1256 tax efficiency &middot; $20K minimum allocation
          </div>
          <a href="#book" className="cta-button">Book a Strategy Session</a>
          <p className="cta-micro">Free 30-min call &mdash; custom portfolio allocation review</p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="beyond-grid">
            <div className="beyond-content">
              <h2>Your Portfolio Deserves Better Than Average</h2>
              <ul className="beyond-points">
                <li>
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                  Multi-asset algorithms across stocks, futures, and crypto &mdash; true diversification, not just different tickers
                </li>
                <li>
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                  Section 1256 futures contracts: 60% long-term / 40% short-term tax treatment regardless of holding period
                </li>
                <li>
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                  Inverse ETF workaround lets you short in Roth IRAs and other restricted accounts
                </li>
                <li>
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                  Turn risk profiles on and off per asset class &mdash; full control over your exposure
                </li>
              </ul>
            </div>
        ...
        <div className="container">
          ...
          <div className="how-steps">
            <div className="how-step">
              ...
              <h3>Portfolio Strategy Session</h3>
              <p>We review your current allocation, account types, and tax situation. Then we design a custom multi-asset algorithm deployment tailored to your goals.</p>
              <div className="how-step-connector" aria-hidden="true" />
            </div>
            <div className="how-step">
              <div className="how-step-number">2</div>
              <h3>White-Glove Setup</h3>
              <p>Our team configures your brokerage connections, risk profiles, and asset class allocations. We handle the technical complexity &mdash; you approve the plan.</p>
              <div className="how-step-connector" aria-hidden="true" />
            </div>
            <div className="how-step">
              <div className="how-step-number">3</div>
              <h3>Optimized Capital at Work</h3>
              <p>Three algorithms work in concert across your portfolio. Monitor everything from your broker dashboard. Adjust risk profiles or pause strategies anytime.</p>
            </div>
          </div>
          ...
          <div className="strategies-grid">
            ...
            <div className="strategy-card">
              ...
              <p className="strategy-approach">
                Trend-following + mean-reversion on mega-cap equities. Ideal for taxable accounts and the inverse ETF strategy for Roth IRAs.
              </p>
            ...
            <div className="strategy-card">
              ...
              <p className="strategy-approach">
                Section 1256 qualified contracts with 60/40 tax treatment. The tax-efficient core of a diversified algorithmic portfolio.
              </p>
              <div className="strategy-stats">
                <div className="strategy-stat">
                  <span className="strategy-stat-label">Historical Return</span>
            ...
            <div className="strategy-card">
              ...
              <p className="strategy-approach">
                Uncorrelated returns in a 24/7 market. Adds a volatility premium to your portfolio that traditional assets can&apos;t provide.
              </p>
              <div className="strategy-stats">
                <div className="strategy-stat">
                  <span className="strategy-stat-label">Historical Return</span>
      ...
      <section className="section">
        <div className="container">
          <div className="section-header">
            ...
            <h2 className="section-title">Built for Sophisticated Investors</h2>
            <p className="section-subtitle">
          ...
          <div className="difference-grid">
            <div className="difference-card">
              ...
              <p className="difference-desc">
                Returns come from edge, not risk amplification. Capital preservation is non-negotiable at this level.
              </p>
            </div>
            <div className="difference-card">
              <div className="difference-icon">
              ...
              <p className="difference-desc">
                Every trade has engineered maximum drawdowns. Your portfolio&apos;s risk budget is respected on every position.
              </p>
            </div>
            <div className="difference-card">
              <div className="difference-icon">
              ...
              <p className="difference-desc">
                Your capital stays in your own accounts at FDIC/SIPC insured brokerages. We never hold, manage, or have access to your funds.
              </p>
            </div>
            <div className="difference-card">
              <div className="difference-icon">
              ...
              <p className="difference-desc">
                Every trade logged. Every P&amp;L visible. We publish losses alongside wins &mdash; no cherry-picking, no simulated results.
              </p>
            </div>
            <div className="difference-card">
              <div className="difference-icon">
              ...
              <p className="difference-desc">
                Section 1256 futures contracts qualify for blended tax rates &mdash; 60% long-term, 40% short-term &mdash; regardless of holding period. A significant edge for high-income earners.
              </p>
            </div>
            <div className="difference-card">
              <div className="difference-icon">
              ...
              <p className="difference-desc">
                Visible logic: RSI divergence, VWAP levels, session opens. You can see and understand exactly why every trade was taken.
              </p>
            </div>
          </div>
          <div className="section-cta">
        ...
        <div className="container">
          ...
          <div className="testimonials-grid">
            ...
            <div className="testimonial-card">
              <Stars />
              <p>
                &ldquo;The Section 1256 tax treatment on futures alone justified the investment.
                Add in the actual returns, and this is the most capital-efficient allocation in my portfolio.&rdquo;
              </p>
              <div className="testimonial-footer">
                <div className="testimonial-avatar avatar-blue">DM</div>
                <div className="testimonial-author">
                  <strong>David M. <span className="verified-badge">Verified</span></strong>
            ...
            <div className="testimonial-card">
              ...
              <div className="testimonial-footer">
                <div className="testimonial-avatar avatar-orange">CS</div>
                <div className="testimonial-author">
            ...
            <div className="testimonial-card">
              <Stars />
              <p>
                &ldquo;Running all three strategies across different account types. The diversification
                and tax efficiency is exactly what my CPA recommended.&rdquo;
              </p>
              <div className="testimonial-footer">
                <div className="testimonial-avatar avatar-pink">RA</div>
                <div className="testimonial-author">
                  <strong>Robert A. <span className="verified-badge">Verified</span></strong>
      ...
      <Script src="/smart-capture/config-portfolio.js" strategy="afterInteractive" />
