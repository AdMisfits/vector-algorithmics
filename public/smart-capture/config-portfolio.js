window.SMART_CAPTURE_CONFIG = {
  ...
  funnelKey: "vector-portfolio-session",
  ...
  hero: {
    eyebrow: "Portfolio screening",
    title: "Book a Strategy Session",
    description: "Answer two quick questions first so the calendar opens only for qualified leads."
  },
  calendar: {
    url: "https://links.vectoralgorithmics.io/widget/booking/yaDsuaLv7xgCEVqasbkw",
  ...
  ghl: {
    ...
    tags: ["smart-capture", "strategy-session", "smart-capture-optin", "icp-portfolio-diversifier"],
    customFieldMap: {
          ...
          options: [
            {
              label: "Under $50k",
              value: "under_50k",
              description: "Our multi-asset strategies require minimum allocations per asset class."
            },
            {
              label: "$50k to $100k",
              value: "50k_100k"
  ...
  qualification: {
    ...
    rules: [
      {
        field: "capital_range",
        operator: "in",
        value: ["50k_100k", "100k_250k", "250k_plus"],
    ...
    failure: {
      ...
      description: "Our multi-asset algorithmic portfolio requires a minimum allocation of $50k. If that changes, use the link below and we can revisit fit.",
